...
test_loader_107=DataLoader(RNA_test_Dataset(test107),batch_size=32,shuffle=False)
test_loader_130=DataLoader(RNA_test_Dataset(test130),batch_size=32,shuffle=False)
...
test107 = test107.copy()
test107["pseudo_reactivity"] = pseudo_labels[:,:,0].tolist()
test107["pseudo_deg_Mg_pH10"] = pseudo_labels[:,:,1].tolist()
test107["pseudo_deg_pH10"] = pseudo_labels[:,:,2].tolist()
test107["pseudo_deg_Mg_50C"] = pseudo_labels[:,:,3].tolist()
test107["pseudo_deg_50C"] = pseudo_labels[:,:,4].tolist()
...
test130 = test130.copy()
test130["pseudo_reactivity"] = pseudo_labels[:,:,0].tolist()
test130["pseudo_deg_Mg_pH10"] = pseudo_labels[:,:,1].tolist()
test130["pseudo_deg_pH10"] = pseudo_labels[:,:,2].tolist()
test130["pseudo_deg_Mg_50C"] = pseudo_labels[:,:,3].tolist()
test130["pseudo_deg_50C"] = pseudo_labels[:,:,4].tolist()
# %%
...
#             schedule.step()
    ...
    if val_loss<best_loss:
        ...
        torch.save(model.state_dict(),'RibonanzaNet-Deg_30_68_re.pt')
...
for epoch in range(epochs):
    ...
    if val_loss<best_loss:
        best_loss=val_loss
        best_preds=val_preds
        torch.save(model.state_dict(),'RibonanzaNet-Deg_31_68_re.pt')
