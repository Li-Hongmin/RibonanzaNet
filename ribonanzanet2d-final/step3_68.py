...
#             schedule.step()
    ...
    if val_loss<best_loss:
        ...
        torch.save(model.state_dict(),'RibonanzaNet-Deg_30_68.pt')
...
epochs=10
cos_epoch=7
model.load_state_dict(torch.load("RibonanzaNet-Deg_30_68.pt",map_location=device))
best_loss=np.inf
...
for epoch in range(epochs):
    ...
    if val_loss<best_loss:
        best_loss=val_loss
        best_preds=val_preds
        torch.save(model.state_dict(),'RibonanzaNet-Deg_31_68.pt')
