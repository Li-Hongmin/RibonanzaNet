...
echo "Start training"
python train_ribonanzanet.py --save_dir saved_models_mamaba --epochs 100 --batch_size 32 --lr 0.001 --max_seq_length 68 --use_mamba_end True --config_path configs/pairwise_no_mamba.yaml --use_hybrid True